  ...
  return (
    <div className="space-y-6 p-8">
      <header className="mb-1 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-extrabold text-[#414042]">Earthquake Risk Analysis</h1>
          <p className="mt-1 text-sm text-[#414042]/80">As of March 18, 2026 • Regional Seismic Activity Overview</p>
        </div>
        <div className="rounded-xl border border-[#d2232a]/20 bg-white/92 px-4 py-2 text-[11px] font-semibold text-[#414042]/80 shadow-sm backdrop-blur-sm">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 space-y-4 lg:col-span-7">
          ...
          <div className="rounded-2xl border border-[#d2232a]/20 bg-white/92 p-4 shadow-sm">
            <div className="mb-3 flex items-center gap-2">
              <Info size={14} className="text-[#911d1f]" />
              <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-[#414042]/80">Legend And Indicators</span>
            </div>
            <div className="grid grid-cols-3 gap-4 text-[10px] font-semibold text-[#414042]">
              <div className="flex items-center gap-2"><span className="h-3 w-3 rounded-full border border-[#414042]/35 bg-white" /> BSU Campus</div>
              <div className="flex items-center gap-2"><span className="h-1 w-5 bg-[#d2232a]/70" /> Epicenter Link</div>
              <div className="flex items-center gap-2"><span className="h-2.5 w-2.5 rounded-full bg-[#d2232a]" /> Earthquake Source</div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-12 space-y-6 lg:col-span-5">
          <div className="relative overflow-hidden rounded-3xl border border-[#d2232a]/20 bg-gradient-to-br from-white/95 to-[#d2232a]/14 p-6 shadow-[0_20px_65px_rgba(65,64,66,0.12)]">
            ...
            <h3 className="mb-5 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.14em] text-[#911d1f]">
              <ShieldAlert size={15} /> Latest Earthquake
            </h3>

            <div className="mb-5 flex items-center gap-5">
              <div className="flex h-24 w-24 flex-col items-center justify-center rounded-3xl bg-gradient-to-br from-[#911d1f] to-[#d2232a] text-white shadow-lg shadow-[#d2232a]/35">
              ...
              <div>
                <h2 className="text-lg font-bold leading-tight text-[#414042]">{latestEQ.location}</h2>
          ...
          <div className="overflow-hidden rounded-3xl border border-[#d2232a]/20 bg-white/96 shadow-[0_20px_65px_rgba(65,64,66,0.1)]">
            <div className="flex items-center justify-between border-b border-[#d2232a]/15 p-5">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-[#d2232a]/8">
                  <th className="px-5 py-3 text-[10px] font-bold uppercase text-[#414042]/70">Campus</th>
                  <th className="px-5 py-3 text-center text-[10px] font-bold uppercase text-[#414042]/70">Distance (km)</th>
                  <th className="px-5 py-3 text-right text-[10px] font-bold uppercase text-[#414042]/70">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#d2232a]/10">
                {campusDistances.map((campus) => (
                  <tr key={campus.name} className="transition-colors hover:bg-[#d2232a]/8">
                    <td className="px-5 py-4 text-xs font-bold text-[#414042]">{campus.name}</td>
                    <td className="px-5 py-4 text-center text-xs font-mono text-[#414042]/80">
          ...
          <div className="rounded-2xl border border-[#d2232a]/20 bg-gradient-to-br from-white/95 to-[#d2232a]/12 p-4 shadow-sm">
            <div className="mb-3 flex items-center gap-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="rounded-xl border border-[#d2232a]/20 bg-white/92 p-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.08em] text-[#414042]/80">Nearest Campus</p>
                <p className="mt-1 text-xs font-semibold text-[#414042]">{nearestCampus.name}</p>
              </div>
              <div className="rounded-xl border border-[#d2232a]/20 bg-white/92 p-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.08em] text-[#414042]/80">Distance</p>
                <p className="mt-1 text-xs font-semibold text-[#414042]">{nearestCampus.distanceKm.toFixed(0)} km</p>
              </div>
              <div className="rounded-xl border border-[#d2232a]/20 bg-white/92 p-2">
                <p className="text-[10px] font-bold uppercase tracking-[0.08em] text-[#414042]/80">Advisory</p>
                <p className="mt-1 text-xs font-semibold text-[#414042]">{advisoryLevel}</p>
              </div>
            </div>

            <div className="mt-3 rounded-xl border border-[#d2232a]/20 bg-white/92 p-3">
            ...
            <div className="mt-3 rounded-xl border border-[#d2232a]/20 bg-white/92 p-3">
              ...
              <div className="mt-2 space-y-1 text-xs text-[#414042]">
